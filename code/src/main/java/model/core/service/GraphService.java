...
//        System.out.println();
    ...
    public List<Journey> getJourneysForDeliveryProcess(final List<Journey> journeys, final DeliveryProcess deliveryProcess) {
        ...
        for (int i = index_journey_start; i <= index_journey_end; i++) {
