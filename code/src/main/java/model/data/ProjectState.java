...
public enum ProjectState {
     ...
     * No points are selected, the user has to select the
     * 1st point of the DeliveryProcess
     */
     ...
     * selected, the user just has to save
     * in order to add the DeliveryProcess
     */
